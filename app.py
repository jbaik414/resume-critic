...
st.markdown("""
    <div style="text-align: center; padding: 20px;">
        ...
        <p style="font-size:18px;">Get instant, AI-powered feedback on your resume for top tech jobs.</p>
    </div>
    ...
    for f in feedback:
        ...
        st.markdown(f"""
         <div style="
            ...
            color:#000000;
         ">
            <h4 style="color:#1F618D;">{f['job_title']}</h4>
            <p>
                <b style="color:#1F618D;">Match Score:</b> {score_display}<br>
                <b style="color:#1F618D;">Suggested Keywords:</b> {missing_keywords}
            </p>
         </div>
         """, unsafe_allow_html=True)
